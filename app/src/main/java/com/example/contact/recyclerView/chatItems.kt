...
class chatItems(val uid:String,val user:User,val textMessage:TextMessege,val context:Context):Item() {
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.item_last_messege_textView.text = textMessage.text
